function Footer() {
	return (
		<footer className='bg-white dark:bg-regal-800'>
			<div className='max-w-7xl mx-auto py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8'>
				<div className='flex justify-center space-x-6 md:order-2'>
					...
					>
						...
						>
							<g>
								...
								/>
								<path
									className='text-white dark:text-regal-800'
									fill='currentColor'
					...
					{/* <a href='#' className='text-gray-400 dark:text-white hover:text-indigo-600 dark:hover:text-green-300'>
