...
function ToggleDarkMode(props) {
	...
	return (
		...
		>
			...
			<span
				className={`pointer-events-none relative inline-block h-5 w-5 rounded-full bg-white dark:bg-blue-900 shadow transform ring-0 transition ease-in-out duration-200 ${
			...
			>
				...
				<span
					...
					aria-hidden='true'
				>
					<svg className='bg-white dark:bg-blue-900 h-3 w-3 text-indigo-600 dark:text-green-300' viewBox='0 0 20 20' fill='currentColor'>
						<path
							fillRule='evenodd'
				...
				<span
					...
					aria-hidden='true'
				>
					<svg className='bg-white dark:bg-blue-900 h-3 w-3 text-indigo-600 dark:text-green-300' fill='currentColor' viewBox='0 0 24 24'>
						<path
							strokeLinecap='round'
