		...
		<section className='lg:relative flex flex-col lg:flex-row'>
			<div className='w-full lg:w-1/2 text-center lg:text-left dark:bg-regal-800'>
				<div className='px-4 py-12 sm:px-8 xl:pr-16'>
					<h1 className='dark:text-white text-5xl'>Tim Lisiecki</h1>
			...
			<div className='relative w-full h-64 sm:h-72 md:h-96 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 lg:h-full'>
				<img className='absolute inset-0 w-full h-full object-cover object-top' src='/images/tim.jpg' alt='Tim Lisiecki headshot' />
			</div>
		</section>
	);
}
